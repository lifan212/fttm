...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0d34b74728052482, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_0d34b74728052482, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "fttm.fttm.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "fttm.fttm.QueryParamsResponse")
}

func init() { proto.RegisterFile("fttm/fttm/query.proto", fileDescriptor_0d34b74728052482) }

var fileDescriptor_0d34b74728052482 = []byte{
	// 289 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x4d, 0x2b, 0x29, 0xc9,
	...
	0x1c, 0x06, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x56, 0xde, 0x1e, 0xf1, 0xb2, 0x01, 0x00,
	0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fttm.fttm.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fttm.fttm.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "fttm/fttm/query.proto",
}
