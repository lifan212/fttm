...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_d317bc1843d723b6, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d317bc1843d723b6, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "fttm.fttm.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "fttm.fttm.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("fttm/fttm/tx.proto", fileDescriptor_d317bc1843d723b6) }

var fileDescriptor_d317bc1843d723b6 = []byte{
	// 312 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x4a, 0x2b, 0x29, 0xc9,
	...
	0xba, 0x06, 0xc3, 0xd0, 0xf4, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fttm.fttm.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fttm.fttm.Msg/UpdateParams",
	}
